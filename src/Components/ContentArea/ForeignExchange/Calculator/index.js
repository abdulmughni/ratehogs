          ...
          <div className="calculator-keypad">
            <div className="input-keys">
              ...
              <div className="digit-keys">
                <CalculatorKey className="key-0" onPress={() => this.inputDigit(0)}>FX</CalculatorKey>
            ...
            <div className="operator-keys">
              ...
              <CalculatorKey className="key-clear" onPress={() => clearDisplay ? this.clearDisplay() : this.clearAll()}>DEL</CalculatorKey>
            </div>
          </div>
          <div className="convert-keys">
              <CalculatorKey className="key-convert" onPress={() => this.performOperation('=')}>CONVERT</CalculatorKey>
            </div>
        </div>
      )
    }
